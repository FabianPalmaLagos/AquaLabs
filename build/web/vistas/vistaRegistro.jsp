<%-- 
    ...
    Created on : 07-06-2021, 21:10:13
    Author     : Fabian Palma
--%>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <form class="d-flex">
                                    ...
                                    <a href="login.html" class="btn btn-dark me-1" role="button">Login</a>
                                    <a href="register.html" class="btn btn-dark me-1" role="button">Registrarse</a>
                                </form>
                            </div>
                        </div>
                    </nav>
                ...
                <div class="container mt-5">
                   <div class="row">
                       ...
                       <div class=" ">
                           ...
                           <h2 class="fw-bold text-center pt-5 mb-5" style="">${ resp }</h2>
